...
a readme file namely README.md explaining how to run the script, what it does and how it works
### Code Setup 

### Code Execution

##Notes: 
For the tidy dataset created from the run_analysis.r, you can check CodeBook.md in this repo.
